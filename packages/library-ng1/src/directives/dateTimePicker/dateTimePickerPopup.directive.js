    ...
    return {
        ...
        link: function (scope, element, attrs, ngModel) {
            ...
            popoverTemplate.attr({
                ...
                'display-format-12hr': attrs.displayFormat12hr,
                'display-format-24hr': attrs.displayFormat24hr,
            });
            ...
            element.popover({
                ...
                trigger: 'manual',
                placement: function() { return attrs.placement ? $parse(attrs.placement)(scope) : 'bottom'; },
                html: true
            });
            //attributes to watch

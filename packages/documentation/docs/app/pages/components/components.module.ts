...
const ROUTES: Routes = [
    {
        ...
        children: [
            ...
            { path: 'draggable-cards', loadChildren: './components-sections/draggable-cards/draggable-cards.module#ComponentsDraggableCardsModule' },
            { path: 'draggable-panels', loadChildren: './components-sections/draggable-panels/draggable-panels.module#ComponentsDraggablePanelsModule' },

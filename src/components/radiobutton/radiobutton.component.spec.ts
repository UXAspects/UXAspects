...
describe('Radio Button Component - Value', () => {
  ...
  it('should disable an option when the [disabled] input changes', () => {
    ...
    expect(
      getRadioButtonLabel(0, nativeElement).classList.contains('ux-radio-button-disabled')
    ).toBeTruthy();

    expect(getNativeRadioButton(1, nativeElement).disabled).toBeFalsy();
    expect(
      getRadioButtonLabel(1, nativeElement).classList.contains('ux-radio-button-disabled')
    ).toBeFalsy();

    expect(getNativeRadioButton(2, nativeElement).disabled).toBeFalsy();
    expect(
      getRadioButtonLabel(2, nativeElement).classList.contains('ux-radio-button-disabled')
    ).toBeFalsy();
  });
  ...
  it('should simplify an option when the [simplified] input changes', () => {
    ...
    expect(
      getRadioButtonLabel(0, nativeElement).classList.contains('ux-radio-button-simplified')
    ).toBeTruthy();
    expect(
      getRadioButtonLabel(1, nativeElement).classList.contains('ux-radio-button-simplified')
    ).toBeTruthy();
    expect(
      getRadioButtonLabel(2, nativeElement).classList.contains('ux-radio-button-simplified')
    ).toBeTruthy();
  });
...
@Component({
  ...
  template: `
    <div role="radiogroup" uxRadioButtonGroup [(value)]="selected" class="radio-button-container">
      ...
      <ux-radio-button name="group" [option]="radioOptions.option3" [simplified]="simplified">
        Option3
      </ux-radio-button>
    </div>
  `,
    ...
    <form [formGroup]="form">
      <div (valueChange)="onButtonClick()" uxRadioButtonGroup formControlName="option">
        <ux-radio-button
          ...
          [simplified]="simplified"
          [option]="1"
          >Option 1</ux-radio-button
        >
        <ux-radio-button [simplified]="simplified" [option]="2" [required]="required"
          >Option 2</ux-radio-button
        >
      </div>
    </form>
  `,
...
describe('Radio Button Component - Reactive Form', () => {
  ...
  it('should add a required attribute to the input when required is true', () => {
    ...
    const inputElementEmpty = nativeElement.querySelectorAll<HTMLInputElement>(
      'input.ux-radio-button-input'
    );
...
function getRadioButtonContent(index: number, nativeElement: HTMLElement): string {
  return getRadioButton(index, nativeElement).querySelector<HTMLDivElement>(
    '.ux-radio-button-label'
  ).innerText;
}

...
import {
  DatePickerHeaderEvent,
  DateTimePickerService,
  YearRange,
} from '../date-time-picker.service';
...
export class YearViewService implements OnDestroy {
  ...
  constructor() {
    ...
    const event = this._datepicker.headerEvent$.subscribe(_event =>
      _event === DatePickerHeaderEvent.Next ? this.goToNextDecade() : this.goToPreviousDecade()
    );

...
describe('Number Picker Component - FormGroup', () => {
  ...
  describe('on scroll', () => {
    ...
    it('should change the value if the picker is focused', async () => {
      ...
      const numberPicker = fixture.debugElement.query(By.directive(NumberPickerComponent));

      numberPicker.triggerEventHandler('focusin');
      fixture.detectChanges();
      await fixture.whenStable();
    ...
    it('should stop changing the value if the picker is blured', async () => {
      ...
      numberPicker.triggerEventHandler('focusout');
      fixture.detectChanges();
      await fixture.whenStable();

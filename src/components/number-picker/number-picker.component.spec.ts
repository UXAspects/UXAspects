...
describe('Number Picker Component - FormGroup', () => {
    ...
    beforeEach(async(() => {
        TestBed.configureTestingModule({
            ...
            declarations: [NumberPickerTestFormGroupComponent]}).compileComponents();
    }));
    ...
    it('should not display ux-number-picker-invalid when max value increased to match input value  ', async () => {
        ...
        component.max = 15;
        fixture.detectChanges();
        component.form.controls.integer.setValidators([
            Validators.required,
            Validators.min(-10),
            Validators.max(15)
        ]);
...
fdescribe('Number Picker Component - value', () => {
    ...
    it('should display ux-number-picker-invalid class when value above max value', async () => {
        ...
        expect(
            numberPicker.classList.contains('ux-number-picker-invalid')).toBe(true);
    });

...
describe('Column Picker Component', () => {
  ...
  it('should display the correct number of deselected columns', () => {
    ...
    const deselected = nativeElement
      .querySelector('.column-picker-list')
      .querySelectorAll('.column-picker-list-item').length;
...
describe('Column Picker Component - Sort Input', () => {
  ...
  function getRowTextContents(listIndex: number): string[] {
    return Array.from(
      nativeElement
        .querySelectorAll('.column-picker-list')
        [listIndex].querySelectorAll('.column-picker-list-item')

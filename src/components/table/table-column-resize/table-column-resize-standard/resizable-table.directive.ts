import { ContentChildren, Directive, ElementRef, Inject, OnDestroy, QueryList, Renderer2 } from '@angular/core';
...
export class ResizableTableDirective extends BaseResizableTableDirective implements OnDestroy {

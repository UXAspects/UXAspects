...
describe('Marquee Wizard', () => {
  ...
  it('should display a title in the side pane', () => {
...
@Component({
  ...
  template: `
    <ux-marquee-wizard [stepTemplate]="stepTemplate">
      ...
      <ux-marquee-wizard-step header="Step One" [context]="{ count: 123 }">
      </ux-marquee-wizard-step>

      <ux-marquee-wizard-step header="Step Two" [context]="{ count: 456 }">
      </ux-marquee-wizard-step>
    </ux-marquee-wizard>
  `,
  standalone: false,

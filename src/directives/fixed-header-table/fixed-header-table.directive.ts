...
export class FixedHeaderTableDirective<T> implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this._tableHead = this._elementRef.nativeElement.querySelector(
      'thead'
    ) as HTMLTableSectionElement;
    this._tableBody = this._elementRef.nativeElement.querySelector(
      'tbody'
    ) as HTMLTableSectionElement;
  ...
  setLayout(): void {
    ...
    this._renderer.setStyle(
      this._tableBody,
      'height',
      typeof this.tableHeight === 'number' ? `${this.tableHeight}px` : this.tableHeight
    );
  }

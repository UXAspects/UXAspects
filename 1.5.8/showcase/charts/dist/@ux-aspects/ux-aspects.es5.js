...
var DragDirective = (function () {
    ...
    function DragDirective(elementRef, ngZone) {
        ...
        var mousedown$ = fromEvent$1(elementRef.nativeElement, 'mousedown');
        var mousemove$ = fromEvent$1(document, 'mousemove');
        var mouseup$ = fromEvent$1(document, 'mouseup');
...
var NavigationItemComponent = (function () {
    ...
    function NavigationItemComponent(_elementRef, _renderer, _parent, _router, _activatedRoute) {
        ...
        this._navigationEnd = _router.events.pipe(filter_2(function (event) { return event instanceof NavigationEnd; }))
...
var MediaPlayerTimelineExtensionComponent = (function (_super) {
    ...
    MediaPlayerTimelineExtensionComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        var /** @type {?} */ mousedown$ = Observable$1.fromEvent(this.thumb.nativeElement, 'mousedown');
        var /** @type {?} */ mousemove$ = Observable$1.fromEvent(document, 'mousemove');
        var /** @type {?} */ mouseup$ = Observable$1.fromEvent(document, 'mouseup');

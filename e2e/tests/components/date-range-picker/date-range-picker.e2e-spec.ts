...
describe('Date Range Picker Tests', () => {
  ...
  it('should emit the date on date start change', async () => {
    await page.selectDate(Picker.Start, 2);
    expect(await page.getInputText()).toBe(
      '2 March 2019  12:00 AM GMT — 21 March 2019  11:59 PM GMT'
    );
  });
  ...
  it('should emit the date on date end change', async () => {
    ...
    expect(await page.getInputText()).toBe(
      '4 March 2019  12:00 AM GMT — 25 March 2019  11:59 PM GMT'
    );
  });
  ...
  it('should emit on hour change', async () => {
    ...
    expect(await page.getInputText()).toBe(
      '4 March 2019  1:00 AM GMT — 21 March 2019  12:59 AM GMT'
    );
    ...
    expect(await page.getInputText()).toBe(
      '4 March 2019  12:00 AM GMT — 21 March 2019  11:59 PM GMT'
    );
  });
  ...
  it('should emit on minute change', async () => {
    ...
    expect(await page.getInputText()).toBe(
      '4 March 2019  12:01 AM GMT — 21 March 2019  12:00 AM GMT'
    );
  ...
  it('should emit on timezone change', async () => {
    ...
    expect(await page.getInputText()).toBe(
      '4 March 2019  12:00 AM GMT+1 — 21 March 2019  11:59 PM GMT'
    );

    await page.incrementTimezone(Picker.End);
    expect(await page.getInputText()).toBe(
      '4 March 2019  12:00 AM GMT+1 — 21 March 2019  11:59 PM GMT+1'
    );

    await page.decrementTimezone(Picker.Start);
    expect(await page.getInputText()).toBe(
      '4 March 2019  12:00 AM GMT — 21 March 2019  11:59 PM GMT+1'
    );
  ...
  it('should update date picker when input date is updated', async () => {
    ...
    expect(await page.getInputText()).toBe(
      '1 January 2020 09:00:01 AM GMT — 3 January 2020 10:59:02 PM GMT'
    );

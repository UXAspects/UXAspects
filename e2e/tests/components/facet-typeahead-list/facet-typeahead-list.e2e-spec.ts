...
describe('FacetTypeaheadListPage Tests', () => {
    ...
    it('should start with no facets', () => {
        ...
        expect(browser.imageComparison.checkScreen('facet-typeahead-initial')).toEqual(0);
    });
    ...
    it('should allow addition of facets', () => {
        ...
        expect(browser.imageComparison.checkScreen('facet-typeahead-selection')).toEqual(0);

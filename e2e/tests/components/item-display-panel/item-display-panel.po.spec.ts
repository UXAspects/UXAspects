...
export class ItemDisplayPanelPage {
  ...
  closeButton = element(by.id('panel1')).$(
    'div.ux-item-display-panel > div.ux-side-panel-header > button'
  );
  contentHeader = element(by.id('panel1')).$(
    'div.ux-item-display-panel > div.ux-side-panel-content h1'
  );
  previousButton = element(by.id('panel1')).$(
    'div.ux-item-display-panel > div.ux-side-panel-footer button:nth-of-type(1)'
  );
  nextButton = element(by.id('panel1')).$(
    'div.ux-item-display-panel > div.ux-side-panel-footer button:nth-of-type(2)'
  );

...
describe('Colored Buttons Tests', () => {
  ...
  it('should change colour upon hover', () => {
    functions.hoverOverElement(page.buttonPrimary);
    ...
    functions.hoverOverElement(page.buttonSecondary);
    ...
    functions.hoverOverElement(page.buttonDisabled);

...
describe('SlidersPage Tests', () => {
  ...
  it('should display the expected ticks', () => {
    ...
    expect(page.getTickLabel(page.slider1, 0)).toEqual('Minimum');
    expect(page.getTickLabel(page.slider1, 3)).toEqual('');
    expect(page.getTickLabel(page.slider1, 10)).toEqual('Default');
    expect(page.getTickLabel(page.slider1, 15)).toEqual('');
    expect(page.getTickLabel(page.slider1, 20)).toEqual('Maximum');
    ...
    expect(page.getTickLabel(page.slider2, 0)).toEqual('1');
    expect(page.getTickLabel(page.slider2, 2)).toEqual('');
    expect(page.getTickLabel(page.slider2, 4)).toEqual('5');
    ...
    expect(page.getTickLabel(page.slider3, 0)).toEqual('0');
    expect(page.getTickLabel(page.slider3, 3)).toEqual('3');
    expect(page.getTickLabel(page.slider3, 5)).toEqual('5');
    ...
    expect(page.getTickLabel(page.slider4, 0)).toEqual('0');
    expect(page.getTickLabel(page.slider4, 5)).toEqual('50');
    expect(page.getTickLabel(page.slider4, 7)).toEqual('');
    expect(page.getTickLabel(page.slider4, 10)).toEqual('100');
    ...
    expect(page.getTickLabel(page.slider6, 0)).toEqual('0');
    expect(page.getTickLabel(page.slider6, 5)).toEqual('25');
    expect(page.getTickLabel(page.slider6, 10)).toEqual('50');
    expect(page.getTickLabel(page.slider6, 12)).toEqual('');
    expect(page.getTickLabel(page.slider6, 20)).toEqual('100');
    ...
    expect(page.getTickLabel(page.slider7, 0)).toEqual('0');
    expect(page.getTickLabel(page.slider7, 5)).toEqual('25');
    expect(page.getTickLabel(page.slider7, 6)).toEqual('');
    expect(page.getTickLabel(page.slider7, 10)).toEqual('50');
    expect(page.getTickLabel(page.slider7, 20)).toEqual('100');
  ...
  it('should have persistent tooltips', () => {
    ...
    page.dragAndDropHande(page.slider5, 'lower', {x: 100, y: 0});
    page.dragAndDropHande(page.slider5, 'upper', {x: -2000, y: 0});
    expect(page.confirmTooltipExists(page.slider5, 'lower')).toBeTruthy();
    expect(page.confirmTooltipExists(page.slider5, 'upper')).toBeTruthy();
  ...
  it('should have correct initial values', () => {
    ...
    expect(page.getInputValue(page.input1)).toEqual('25');
    expect(page.getInputValue(page.input2)).toEqual('75');
  ...
  it('should react to drag and drops', () => {
    ...
    page.dragAndDropHande(page.slider1, 'lower', {x: -2000, y: 0});
    ...
    page.dragAndDropHande(page.slider2, 'lower', {x: -2000, y: 0});
    page.mouseDownOnHandle(page.slider2, 'lower');
    ...
    page.dragAndDropHande(page.slider3, 'lower', {x: -2000, y: 0});
    ...
    page.dragAndDropHande(page.slider4, 'lower', {x: -2000, y: 0});
    ...
    page.dragAndDropHande(page.slider5, 'lower', {x: -2000, y: 0});
    ...
    page.dragAndDropHande(page.slider6, 'lower', {x: -2000, y: 0});
    page.moveMouseToHandle(page.slider6, 'lower');
    expect<any>(page.getTooltipValue(page.slider6, 'lower')).toEqual('0');
    page.dragAndDropHande(page.slider6, 'upper', {x: 2000, y: 0});
    page.moveMouseToHandle(page.slider6, 'upper');
    expect<any>(page.getTooltipValue(page.slider6, 'upper')).toEqual('100');
    
    page.dragAndDropHande(page.slider7, 'lower', {x: -2000, y: 0});
    page.moveMouseToHandle(page.slider7, 'lower');
    expect<any>(page.getTooltipValue(page.slider7, 'lower')).toEqual('0');
    page.dragAndDropHande(page.slider7, 'upper', {x: 2000, y: 0});
    page.moveMouseToHandle(page.slider7, 'upper');
  ...
  it('should snap to ticks', () => {
    ...
    // Narrow - Track Styling - Snapping    
    page.dragAndDropHande(page.slider3, 'lower', {x: -100, y: 0});
    ...
    page.dragAndDropHande(page.slider3, 'lower', {x: 1000, y: 0});
    page.mouseDownOnHandle(page.slider3, 'lower');
    expect(page.getHandleAttribute(page.slider3, 'lower', 'style')).toContain('left: 100');
    page.mouseUpFromHandle(page.slider3, 'lower');
  ...
  it('should never allow negative ranges', () => {
    ...
    // Range Track - Persistent Callout
    page.dragAndDropHande(page.slider5, 'lower', {x: 200, y: 0});
    page.dragAndDropHande(page.slider5, 'upper', {x: -2000, y: 0});
    ...
    // Range Track Style - Custom Callout Styles
    page.dragAndDropHande(page.slider6, 'upper', {x: -100, y: 0});
    page.dragAndDropHande(page.slider6, 'lower', {x: 2000, y: 0});
  ...
  it('should synchronize with text inputs', () => {
    ...
    page.moveMouseToHandle(page.slider7, 'lower');
    expect<any>(page.getTooltipValue(page.slider7, 'lower')).toEqual('25');
    page.dragAndDropHande(page.slider7, 'lower', {x: -100, y: 0});
    ...
    page.moveMouseToHandle(page.slider7, 'upper');
    expect<any>(page.getTooltipValue(page.slider7, 'upper')).toEqual('75');
    page.dragAndDropHande(page.slider7, 'upper', {x: 100, y: 0});
    ...
    expect(page.getInputValue(page.input1)).toEqual('20');
    expect(page.getInputValue(page.input2)).toEqual('80');

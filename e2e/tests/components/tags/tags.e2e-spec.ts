...
describe('TagsPage Tests', () => {
  ...
  it('should start with three tags, the customize example section closed and no error messages visible', () => {
    ...
    expect(page.getNumberOfTags()).toEqual(3);    
    ...
    expect(page.confirmCustomizeExampleSectionIsOpen()).toBeFalsy();
  ...
  it('should allow expansion and contraction of the customize example section', () => {
    
    page.toggleCustomizeExampleSection();
    expect(page.confirmCustomizeExampleSectionIsOpen()).toBeTruthy();    
    page.toggleCustomizeExampleSection();
    expect(page.confirmCustomizeExampleSectionIsOpen()).toBeFalsy();
  ...
  it('should allow addition of tags', () => {
    ...
    expect(page.getNumberOfTags()).toEqual(4);    
  ...
  it('should allow deletion of all tags one by one', () => {
    ...
    page.closeATag(2); 
    expect(page.getNumberOfTags()).toEqual(2);
    page.closeATag(0);    
    expect(page.getNumberOfTags()).toEqual(1);
    page.closeATag(0);    
    expect(page.getNumberOfTags()).toEqual(0);
  ...
  it('should allow the number of tags to fall below the minimum limit', () => {
    ...
    expect(page.getRangeErrorMessage()).toEqual('Required: number of tags between 1 and 10.');
  ...
  it('should allow the number of tags to rise above the maximum limit', () => {
    ...
    expect(page.getNumberOfTags()).toEqual(16);
    expect(page.confirmRangeErrorIsVisible()).toBeTruthy();
  ...
  it('should prevent tag addition or deletion when a limit would be breached', () => {
    ...
    page.copyAndPasteTags('Beta,Gamma,Delta,Epsilon,Zeta,Eta,Theta,Iota,Kappa,Lambda');
  ...
  it('should allow adjustment of the minimum limit', () => {
    ...
    expect(page.getNumberOfTags()).toEqual(1);
    expect(page.confirmRangeErrorIsVisible()).toBeTruthy();
    expect(page.getRangeErrorMessage()).toEqual('Required: number of tags between 2 and 10.');
  ...
  it('should allow adjustment of the maximum limit', () => {
    ...
    expect(page.getNumberOfTags()).toEqual(5);
    expect(page.confirmRangeErrorIsVisible()).toBeTruthy();
  ...
  it('should allow changing of the placeholder text', () => {
    ...
    expect(page.getTagInputsPlaceholderText()).toEqual('Add tags here!');
  ...
  it('should allow changing of the tag delimiter characters', () => {
    ...
    expect(page.getNumberOfTags()).toEqual(9);
  ...
  it('should display tags in the typeahead list', () => {
    ...
    expect(page.getNumberOfTagsInTypeaheadList()).toEqual(5);
  ...
  it('should allow the highlighting of the first enabled tag in the typeahead list', () => {
  ...
  it('should display the typeahead list when the tags input area is clicked', () => {
    ...
    expect(page.getNumberOfTagsInTypeaheadList()).toEqual(24);

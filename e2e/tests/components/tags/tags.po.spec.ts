...
export class TagsPage {
  ...
  async copyAndPasteTags(tags: string) {
    ...
    await this.tagsInput
      ...
      .$('li.ux-tag-input')
      .$('input.ux-tag-input')
      .sendKeys(Key.chord(Key.CONTROL, 'v') + Key.ENTER);
  }
  ...
  waitForTypeaheadListToBeDisplayed() {
    return browser.wait(
      protractor.ExpectedConditions.visibilityOf(this.tagsInput.$('ux-typeahead'))
    );
  }

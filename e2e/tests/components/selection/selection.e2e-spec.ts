...
describe('Selection Tests', () => {
  ...
  it('should select a row on click (simple)', async () => {
    ...
    expect(await page.getSelection()).toBe(
      '[ { "name": "Document 1", "author": "John Smith", "selected": true } ]'
    );
  });
  ...
  it('should allow multiple click selections (simple)', async () => {
    ...
    // the selection should be updated
    expect(await page.getSelection()).toBe(
      '[ { "name": "Document 1", "author": "John Smith", "selected": true }, { "name": "Document 2", "author": "John Smith", "selected": true } ]'
    );
  });
  ...
  it('should allow select all (simple)', async () => {
    ...
    // the selection should be updated
    expect(await page.getSelection()).toBe(
      '[ { "name": "Document 1", "author": "John Smith", "selected": true }, { "name": "Document 2", "author": "John Smith", "selected": true }, { "name": "Document 3", "author": "John Smith", "selected": true }, { "name": "Document 4", "author": "John Smith", "selected": true } ]'
    );
  });
  ...
  it('should allow keyboard navigation (simple)', async () => {
    ...
    expect(await page.getSelection()).toBe(
      '[ { "name": "Document 2", "author": "John Smith", "selected": true } ]'
    );
  });
  ...
  it('should allow keyboard navigation (row-alt)', async () => {
    ...
    // second and third
    expect(await page.getSelection()).toBe(
      '[ { "name": "Document 2", "author": "John Smith", "selected": true }, { "name": "Document 3", "author": "John Smith", "selected": true } ]',
      '3. shift+down'
    );
    ...
    expect(await page.getSelection()).toBe(
      '[ { "name": "Document 2", "author": "John Smith", "selected": true }, { "name": "Document 3", "author": "John Smith", "selected": true }, { "name": "Document 4", "author": "John Smith", "selected": true } ]',
      '5. space'
    );
    ...
    // fourth
    expect(await page.getSelection()).toBe(
      '[ { "name": "Document 4", "author": "John Smith", "selected": true } ]',
      '6. down'
    );
  });

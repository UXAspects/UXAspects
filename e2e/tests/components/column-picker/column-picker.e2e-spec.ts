...
describe('Column Picker Tests', () => {
  ...
  it('should have the correct initial state', async () => {
    ...
    expect(await page.getSelection()).toBe(
      '[ "Type", "Date", "Requested by", "Status", "Completion" ]'
    );
    expect(await page.getDeselection()).toBe(
      '[ { "group": "Metadata", "name": "Author" }, { "group": "Metadata", "name": "Category" }, { "group": "Metadata", "name": "Date Created" }, { "group": "Metadata", "name": "Date Modified" }, { "group": "Metadata", "name": "Department" }, "Document ID", "Flag", "From", "Icon", "Importance", "Location", "Location ID", "Message", { "group": "Metadata", "name": "Organization" }, "Time", "Time Created", "Time Modified", "Work Completed" ]'
    );
  ...
  it('should allow moving a deselected column', async () => {
    ...
    expect(await page.getSelection()).toBe(
      '[ "Type", "Date", "Requested by", "Status", "Completion", { "group": "Metadata", "name": "Author" } ]'
    );
  });
  ...
  it('should allow reordering', async () => {
    ...
    expect(await page.getSelection()).toBe(
      '[ "Date", "Type", "Requested by", "Status", "Completion" ]'
    );
  });

...
export class PageHeaderPage {
  ...
  async confirmApplicationLogoIsPresent() {
    return element(by.id('pageHeader1'))
  ...
  confirmNotificationIconIsPresent() {
    return element(by.id('pageHeader1'))
      .$('div.page-header-icon-menus')
      .$$('ux-page-header-icon-menu')
      .get(0)
      .$('div.page-header-icon-menu')
  ...
  async getSecondaryNavigation(): Promise<ElementFinder> {
    return await element(by.id('pageHeader2')).$(
      '.ux-page-header-secondary .page-header-navigation'
    );
  }

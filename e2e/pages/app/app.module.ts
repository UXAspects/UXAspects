...
const routes: Routes = [
    ...
    },
    {
        ...
        loadChildren: () =>
            import('./date-time-picker/date-time-picker.module').then(m => m.DateTimePickerTestPageModule),
    },
    {
        path: 'date-range-picker',
        loadChildren: () =>
            import('./date-range-picker/date-range-picker.module').then(m => m.DateRangePickerTestPageModule),
    },
    {
        path: 'expanding-text-area',
        loadChildren: () =>
            import('./expanding-text-area/expanding-text-area.module').then(m => m.ExpandingTextAreaModule),
    },
    {
        path: 'facet-check-list',
        loadChildren: () =>
            import('./facet-check-list/facet-check-list.module').then(m => m.FacetCheckListTestPageModule),
    },
    {
    ...
    },
    {
        ...
        loadChildren: () =>
            import('./facet-typeahead-list/facet-typeahead-list.module').then(m => m.FacetTypeaheadListPageModule),
    },
    {
        path: 'filters',

...
export class NotificationTestPageComponent {
  ...
  @ViewChild('notification', { static: false }) notification: TemplateRef<void>;
  ...
  showNotification(spacing?: number): void {
    this._notificationService.show(
      ...
      },
      {
        ...
        description:
          'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque cursus ex vel placerat porta.',
      }
    );

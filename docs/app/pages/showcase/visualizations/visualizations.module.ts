    ...
    children: [
      {
        ...
        component: OrganizationChartShowcaseComponent,
        data: { title: 'Organization Chart', navigation: false },
      },
      {
        path: 'partition-map',
        component: PartitionMapShowcaseComponent,
        data: { title: 'Partition Map', navigation: false },
      },
      {
        path: 'sankey-chart',
        component: SankeyChartShowcaseComponent,
        data: { title: 'Sankey Chart', navigation: false },
      },

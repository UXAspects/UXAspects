  ...
  implements IPlaygroundProvider
{
  posts: Post[] = [
    ...
    },
    {
      ...
      date: chance.date({ year: 2018 }) as Date,
      content:
        'Ivy is the next generation of Angular Renderer. It is third in line after the original compiler (for Angular 2) and Renderer2 (for Angular 4 and above).',
    },
    {
      title: 'Angular Console — The UI for the Angular CLI',
      date: chance.date({ year: 2018 }) as Date,
      content:
        'Angular CLI transformed the Angular ecosystem. We no longer have to spend time maintaining our webpack configurations, figuring out how to make tests run, fixing source maps — the CLI does this for us.',
    },
    {

angular.module('app').directive('uxdSlidersWrapper', () => {
    return {
        restrict: 'E',
        controller: 'SlidersCtrl as vm',
        template: require('./sliders-wrapper.directive.html'),
        scope: true
    };
});
...
SlidersCtrl.$inject = ['$colorService', '$scope'];

function SlidersCtrl($colorService: any, $scope: angular.IScope) {
    var vm = this;

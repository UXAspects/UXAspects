...
@Component({
    selector: 'uxd-components-dashboard-text-widget',
    templateUrl: './dashboard-text-widget.component.html',
    styleUrls: ['./dashboard-text-widget.component.less']
})
@DocumentationSectionComponent('ComponentsDashboardTextWidgetComponent')
export class ComponentsDashboardTextWidgetComponent extends BaseDocumentationSection implements IPlaygroundProvider {

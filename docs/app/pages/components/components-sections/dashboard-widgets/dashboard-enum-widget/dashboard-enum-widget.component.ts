...
@Component({
    selector: 'uxd-components-dashboard-enum-widget',
    templateUrl: './dashboard-enum-widget.component.html',
    styleUrls: ['./dashboard-enum-widget.component.less']
})
@DocumentationSectionComponent('ComponentsDashboardEnumWidgetComponent')
export class ComponentsDashboardEnumWidgetComponent extends BaseDocumentationSection implements IPlaygroundProvider {

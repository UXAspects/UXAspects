angular.module('app').directive('uxdHierarchyBarWrapper', () => {
    return {
        restrict: 'E',
        controller: 'HierarchyBarDemoCtrl as vm',
        template: require('./hierarchy-bar-wrapper.directive.html')
    };
});
...
function HierarchyBarDemoCtrl($q: angular.IQService, $timeout: angular.ITimeoutService) {
    var vm = this;

    let chance = require('chance').Chance();

    var adminIcon = require('../../../../../../assets/img/IconUser.png');
    var userIcon =  require('../../../../../../assets/img/IconManagerColorized.png');
    ...
    function addNodeParentRefs(node?: any, parent?: any) {
    ...
    vm.selectBreadcrumb = function (data: any) {

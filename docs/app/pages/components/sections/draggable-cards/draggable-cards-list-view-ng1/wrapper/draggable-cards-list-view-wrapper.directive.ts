angular.module('app').directive('uxdDraggableCardsListViewWrapper', () => {
    return {
        restrict: 'E',
        template: require('./draggable-cards-list-view-wrapper.directive.html'),
        controller: ['$scope', '$colorService', function ($scope, $colorService) {
            ...
            vm.onSelect = function (itemScope: any) {
                ...
                if (category === 'All') {
                    ...
                    vm.items = vm.availableItems.filter(function (item: any) {
            ...
            function getChartOptions(label: any) {
                return {
                    series: {
                        pie: {
                            show: true,

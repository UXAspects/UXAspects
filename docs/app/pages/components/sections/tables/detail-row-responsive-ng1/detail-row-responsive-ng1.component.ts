...
export class ComponentsDetailRowResponsiveNg1Component {
    ...
    public codepen: ICodePen = {
        html: require('./snippets/codepen/detail-row-responsive.html'),
        htmlAttributes: {
            'ng-controller': 'DetailRowResponsiveTableCtrl as vm'
        },
        js: [ require('./snippets/codepen/detail-row-responsive.js') ],
        css: [this.cssCode]
    };
}
...
export class SystemJSHelper {
    ...
    private static _mappings: SystemJSMapping[] = [
        ...
        // Angular CDK
        { name: '@angular/cdk/a11y', path: '@angular/cdk@5.2.5/bundles/cdk-a11y.umd.js' },
        { name: '@angular/cdk/accordion', path: '@angular/cdk@5.2.5/bundles/cdk-accordion.umd.js' },
        { name: '@angular/cdk/bidi', path: '@angular/cdk@5.2.5/bundles/cdk-bidi.umd.js' },
        { name: '@angular/cdk/coercion', path: '@angular/cdk@5.2.5/bundles/cdk-coercion.umd.js' },
        { name: '@angular/cdk/collections', path: '@angular/cdk@5.2.5/bundles/cdk-collections.umd.js' },
        { name: '@angular/cdk/keycodes', path: '@angular/cdk@5.2.5/bundles/cdk-keycodes.umd.js' },
        { name: '@angular/cdk/layout', path: '@angular/cdk@5.2.5/bundles/cdk-layout.umd.js' },
        { name: '@angular/cdk/observers', path: '@angular/cdk@5.2.5/bundles/cdk-observers.umd.js' },
        { name: '@angular/cdk/overlay', path: '@angular/cdk@5.2.5/bundles/cdk-overlay.umd.js' },
        { name: '@angular/cdk/platform', path: '@angular/cdk@5.2.5/bundles/cdk-platform.umd.js' },
        { name: '@angular/cdk/portal', path: '@angular/cdk@5.2.5/bundles/cdk-portal.umd.js' },
        { name: '@angular/cdk/scrolling', path: '@angular/cdk@5.2.5/bundles/cdk-scrolling.umd.js' },
        { name: '@angular/cdk/stepper', path: '@angular/cdk@5.2.5/bundles/cdk-stepper.umd.js' },

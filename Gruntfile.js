...
module.exports = function (grunt) {
    ...
    grunt.registerTask('e2e', ['tslint:e2e', 'clean:e2e', 'webpack:e2e', 'ts:e2e', 'clean:webdriver', 'run:webdriver_manager_update', 'copy:webdriver', 'rename:webdriver', 'run:e2e', 'makeReport']);
